...
public interface GetDogLocal {
    /**
     * Méthode qui permet de trouver et récupérer un chien dans la base de donnée
    ...
    /**
     * Permet de trouver une list de chien dans la base de donnée
     * voir public DogDTO findDog(int ID);
     ...
     * Permet séléctionner les chiens à afficher en fonction de la page et du 
     * nombre de chien par page
     * 
